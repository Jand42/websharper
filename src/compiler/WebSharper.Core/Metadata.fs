...
type Info =
    {
        ...
        Quotations : IDictionary<string * SourcePos, TypeDefinition * Method * list<string>>
...
type ICompilation =
    ...
    abstract GetQuotation : string * SourcePos -> option<TypeDefinition * Method * list<string>>
